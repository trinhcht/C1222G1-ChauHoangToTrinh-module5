                    ...
                    <>
                        <div className="row mx-0" style={{marginTop: 96}}>
                            <img
                                ...
                                alt=""
                            />
                            <h2 className="text-center pt-4" style={{fontFamily: '"Playfair Display"', position: "absolute", margin: "inherit", fontSize: 40, color: "#ffffff", textAlign: "center", fontWeight: 700, fontStyle: "normal"}}>
                                LOẠI PHÒNG
                            </h2>
                        </div>
